...
As of 2026-09-22 (phase numbers updated for roadmap v2.0 on 2026-09-24), these documents are **historical references** — their
...
| [`docs/OPEN_SOURCE_PLAN.md`](OPEN_SOURCE_PLAN.md) | Sep 19 | Claude | 5-phase plan partially executed (WP1–5). Phase 5 was never started. The WP5 causal-loop claim was [withdrawn](OPEN_SOURCE_PLAN.md#correction-2026-09-20-completed-v2-set). Open-source hygiene items are carried forward into P6 (first public release) of roadmap v2.0. |
...
| [`docs/archive/CLAUDE_IMMEDIATE_PLAN.md`](archive/CLAUDE_IMMEDIATE_PLAN.md) | Sep 19 | Claude | 8 work packages with gates. WP1–4 completed. WP5 returned NULL. WP6–8 implemented in v0.3.0; WP6 has only a 1 s v1 smoke run and no behavioural result (see `CAPABILITY_MATRIX.md`). |
...
| Document | Role |
|---|---|
| [`docs/LIF_DYNAMICS_SPEC.md`](LIF_DYNAMICS_SPEC.md) | Technical specification for v1/v2/v3 dynamics. Referenced by P1. |
| [`docs/WP6_PLASTICITY_SPEC.md`](WP6_PLASTICITY_SPEC.md) | Plasticity model specification. Referenced by P4 (after mushroom-body odor learning). |
| [`docs/RELEASE_AUDIT.md`](RELEASE_AUDIT.md) | Open-source hygiene checklist. Referenced by P6 (first public release). |
